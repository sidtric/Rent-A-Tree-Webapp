...
export default function App() {
  ...
  const logout = () => { localStorage.clear(); setUser(null); setRentals([]); setCart([]); setCartOpen(false); setView('home'); };
            ...
            <div className="hero-text">
              ...
              <div className="hero-cta-row">
                ...
                <div className="cta-amber-wrap">
                  <button className="btn-cta-amber" onClick={() => { setView('home'); setTimeout(() => document.getElementById('plans')?.scrollIntoView({ behavior: 'smooth' }), 100); }}>Rent Your Tree Now</button>
                </div>
              </div>
            </div>
